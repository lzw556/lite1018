...
import { AREA_ASSET_TYPES, AREA_ASSET_TYPE_ID } from '../config';
        ...
        .map((node) =>
          mapTreeNode(node, (node) => ({
            ...
            icon: (props: any) => {
              ...
              if (props.type < 10000) {
                return <AreaIcon className={alarmState} />;
              } else {
                        ...
                        onClick={() => {
                          ...
                          if (type < 10000) {
                            getAsset(selectedNode?.id)
                              .then((asset) => {
                                if (asset.type === AREA_ASSET_TYPE_ID) {
                                  onAreaUpdate?.(asset);
                                } else if (AREA_ASSET_TYPES.find((t) => t.key === asset.type)) {
