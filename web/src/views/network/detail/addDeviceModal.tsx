...
const AddDeviceModal: FC<AddDeviceModalProps> = (props) => {
  ...
  const render = () => {
    ...
    return (
      <Form.Item label={'设备选择'} name={'devices'} rules={[Rules.required]}>
        <DeviceSelect
          filters={{ network_id: 0, category: 3 }}
          mode={'multiple'}
          maxTagCount={'responsive'}
          placeholder={'请选择需要接入的设备'}
        />
      </Form.Item>
    );
  };
  ...
  return (
    <Modal {...props} title={'设备添加'} width={420} onOk={onSave}>
