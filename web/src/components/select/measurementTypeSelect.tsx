...
const MeasurementTypeSelect: FC<MeasurementTypeSelectProps> = (props) => {
    return <Select {...props} suffixIcon={<CaretDownOutlined />}>
        ...
        <Select.Option value={MeasurementType.NormalTemperatureCorrosion}>{MeasurementType.toString(MeasurementType.NormalTemperatureCorrosion)}</Select.Option>
        <Select.Option value={MeasurementType.HighTemperatureCorrosion}>{MeasurementType.toString(MeasurementType.HighTemperatureCorrosion)}</Select.Option>
        <Select.Option value={MeasurementType.PressureTemperature}>{MeasurementType.toString(MeasurementType.PressureTemperature)}</Select.Option>
