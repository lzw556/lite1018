...
export const PretighteningSettings = [
...
const PreloadFormItem: FC<PreloadFormItemProps> = ({ enabled }) => {
  ...
  const renderPreloadItems = () => {
    return (
      <>
        <Form.Item
          label={'初始预紧力'}
          name={['sensors', 'initial_pretightening_force']}
          initialValue={0}
          rules={[Rules.number]}
        >
        ...
        <Form.Item
          label={'初始预紧长度'}
          name={['sensors', 'initial_pretightening_length']}
          initialValue={0}
          rules={[Rules.number]}
        >
        ...
        <Form.Item
          label={'截面积'}
          name={['sensors', 'sectional_area']}
          initialValue={1305.462}
          rules={[Rules.number]}
        >
  ...
  return (
    <>
      <Form.Item
        label={'是否启用预警力'}
        name={['sensors', 'pretightening_is_enabled']}
