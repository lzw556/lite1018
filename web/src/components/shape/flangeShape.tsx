    ...
    for (let i = 0; i < quantity; i++) {
      ...
      bolts.push(
        <Circle
          ...
          x={
            center +
            ((innerRadius + outerRadius) / 2) * Math.cos(((angel * i + offset) * Math.PI) / -180)
          }
          y={
            center +
            ((innerRadius + outerRadius) / 2) * Math.sin(((angel * i + offset) * Math.PI) / -180)
          }
          radius={10}
      ...
      >
        <Form form={form} labelCol={{ span: 6 }}>
          ...
          <Form.Item
            ...
            name={'mac'}
            required
            rules={[{ validator: onCheckMadBinding }]}
          >
