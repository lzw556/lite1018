...
func (d NormalTemperatureCorrosion) Settings() Settings {
	...
	d.RodTempK1 = temperatureKSetting("温度补偿系数3", "rod_temp_k1", 0, 5, SettingGroupThickness)
	d.RodTempK2 = temperatureKSetting("温度补偿系数4", "rod_temp_k2", 0.078, 6, SettingGroupThickness)
