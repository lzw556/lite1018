...
type SasRawData struct {
	Metadata struct {
		...
		MinAcceleration      Acceleration `json:"min_acceleration" mapstructure:"min_acceleration"`
		...
		MaxAcceleration      Acceleration `json:"max_acceleration" mapstructure:"max_acceleration"`
	...
	DynamicAcceleration []Acceleration `json:"dynamic_acceleration" mapstructure:"dynamic_acceleration"`
}
