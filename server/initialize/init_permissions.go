...
func initPermissions(db *gorm.DB) error {
	permissions := []entity.Permission{
		...
		},
		{
			Path:        "devices/:id/data/*",
			Method:      "GET",
			Description: "查看设备原始数据",
			Group:       "数据模块",
		},
		{
			Path:        "devices/:id/runtime",
			Method:      "GET",
		...
		{
			Path:        "alarmRules/:id/status/:status",
			Method:      "PUT",
			Description: "编辑报警状态",
			Group:       "报警模块",
		},
